...
The four types, save-at-triggers, body structure, index discipline, the save procedure, and
refresh + drift: [`references/mode-a-mechanics.md`](references/mode-a-mechanics.md). Mode B
sessions skip to "What NOT to save".
