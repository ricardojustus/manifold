...
description: >-
  Reference for writing any document an agent consumes — skills, always-loaded agent files
  (AGENTS.md / CLAUDE.md class), and pointer-reached docs. Invoke BEFORE authoring or editing any
  skill body or description, or any other agent-consumed doc, alongside the harness's own skill
  conventions. Craft reference only —
  creation/eval mechanics belong to the installed skill-creator tooling.
---
