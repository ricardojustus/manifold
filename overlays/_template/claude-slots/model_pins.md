...
<!-- Suggested starting content (public defaults, dated 2026-09-22) — accept, edit, or drop it,
...
Dated pins (public defaults, 2026-09-22). **Re-verify whenever the model lineup changes.**

| Tier | Model | Used for |
|---|---|---|
| **Frontier** | `claude-opus-5-5` | Orchestration, design, spec authoring, severity calls, reviewer/audit seats |
